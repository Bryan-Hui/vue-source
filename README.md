...
| ------------------------------------------ | --------------------------------------------------------- | --------------------------------------------------------- |
| [vue-router][vue-router]                   | [vue-router-status][vue-router-package]                   | Single-page application routing                           |
| [vuex][vuex]                               | [vuex-status][vuex-package]                               | Large-scale state management                              |
| [vue-cli][vue-cli]                         | [vue-cli-status][vue-cli-package]                         | Project scaffolding                                       |
| [vue-loader][vue-loader]                   | [vue-loader-status][vue-loader-package]                   | Single File Component (`*.vue` file) loader for webpack |
| [vue-server-renderer][vue-server-renderer] | [vue-server-renderer-status][vue-server-renderer-package] | Server-side rendering support                             |
| [vue-class-component][vue-class-component] | [vue-class-component-status][vue-class-component-package] | TypeScript decorator for a class-based API                |
| [vue-rx][vue-rx]                           | [vue-rx-status][vue-rx-package]                           | RxJS integration                                          |
| [vue-devtools][vue-devtools]               | [vue-devtools-status][vue-devtools-package]               | Browser DevTools extension                                |
